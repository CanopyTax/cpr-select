...
var CanopySelect = _react2['default'].createClass({
	...
	getInitialState: function getInitialState() {
		...
		if (this.props.selected) {
			selectedIndex = (0, _lodash.findIndex)(this.props.options, { key: this.props.selected });
		}
	...
	getDialog: function getDialog(dialogDisplayed, options) {
		...
		if (dialogDisplayed) {
			var _ret = (function () {
				...
				setTimeout(function () {
					try {
						_react2['default'].findDOMNode(_this5).querySelector('.cp-select__hidden-input').focus();
					} catch (e) {
