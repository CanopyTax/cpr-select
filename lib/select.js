...
var CanopySelect = _react2['default'].createClass({
	...
	triggerItemChange: function triggerItemChange() {
		if (this.props.onChange) {
			this.props.onChange.call(null, this.state.selectedIndex !== null ? this.props.options[this.state.selectedIndex].key : null, this.props.options[this.state.selectedIndex], this.state.selectedIndex);
		}
	},
	...
	getIndexFromString: function getIndexFromString(searchString) {
		...
		return (0, _lodash.findIndex)(this.props.options, function (option) {
			return _this4.getViewValue(option).toLowerCase().indexOf(searchString) === 0;
		});
	},
	...
	getDialog: function getDialog(dialogDisplayed, options) {
		...
		if (dialogDisplayed) {
			var _ret = (function () {
				...
				var blankOption = [_react2['default'].createElement(
					'li',
					{ key: "blankOption", className: selectedIndex === null ? '+selected' : '', onMouseDown: _this5.selectItem.bind(_this5, null) },
				...
				var optionElements = blankOption.concat(options.map(function (option, index) {
				...
				return {
					v: _react2['default'].createElement(
						...
						_react2['default'].createElement(
							'ul',
							{ className: 'cp-select__menu cps-dropdown-menu', style: { top: _this5.positionDialogAndGetTop(options, selectedIndex === null ? 0 : selectedIndex + 1) } },
							optionElements
						)
					)
				};
